      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 shadow-sm">
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-zinc-500 mb-2">
            El texto está en formato HTML. Puedes usar etiquetas como <code>&lt;h2&gt;</code>, <code>&lt;p&gt;</code>, y <code>&lt;strong&gt;</code>.
          </p>
          <textarea
            name="content"
            ...
            required
            rows={20}
            className="w-full font-mono text-sm bg-zinc-50 dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700 text-black dark:text-white rounded-md px-4 py-3"
          />
        </div>
