  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setStatus("error");
        setMessage(data.error || "There was an error sending the message.");
      }
    } catch (error) {
    ...
    <div className="flex flex-col flex-1 bg-white dark:bg-zinc-950 font-sans">
      <main className="flex flex-col max-w-3xl mx-auto w-full px-4 py-12">
        <header className="mb-10 border-b border-zinc-200 dark:border-zinc-800 pb-8">
          <h1 className="text-4xl font-bold font-serif text-black dark:text-white mb-4">Contact</h1>
          <p className="text-lg text-zinc-600 dark:text-zinc-400">
            Have questions, suggestions, or want to collaborate? Write to us and we will respond as soon as possible.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
              <h3 className="text-xl font-bold font-serif text-black dark:text-white mb-4">Contact information</h3>
              <ul className="space-y-4">
                ...
                <li>
                  <h4 className="text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-1">Social media</h4>
                ...
                <li>
                  <h4 className="text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-1">Location</h4>
                  <p className="text-zinc-800 dark:text-zinc-300">Spain</p>
                </li>
              </ul>
            </div>
          </div>
