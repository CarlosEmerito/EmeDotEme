...
export function SearchBar() {
  ...
  const isEnglishPage = pathname?.startsWith('/en') || false;
  
  // Get appropriate placeholder and search path
  const placeholder = isEnglishPage ? "Search news..." : "Buscar noticias...";
  const searchPath = isEnglishPage ? "/en/buscar" : "/buscar";
